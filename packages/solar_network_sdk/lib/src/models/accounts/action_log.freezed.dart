...
class _SnActionLog implements SnActionLog {
  const _SnActionLog({required this.id, required this.action, required  Map<String, dynamic> meta, required this.userAgent, required this.ipAddress, required this.location, required this.accountId, required this.sessionId, required this.createdAt, required this.updatedAt, required this.deletedAt}): _meta = meta;
