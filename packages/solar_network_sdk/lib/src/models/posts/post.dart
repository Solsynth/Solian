...
sealed class SnPost with _$SnPost {
  const factory SnPost({
    ...
    @JsonKey(name: 'chained_post_id') String? chainedPostId,
    @JsonKey(name: 'chained_post') SnPost? chainedPost,
    @JsonKey(name: 'chained_posts') @Default([]) List<SnPost> chainedPosts,
    @JsonKey(name: 'chained_count') @Default(0) int chainedCount,
    String? realmId,
    SnRealm? realm,
    String? publisherId,
