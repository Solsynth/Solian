...
@useResult
$Res call({
 String id, String? name, String? description, String? slug, int type,@JsonKey(name: 'encryption_mode') int encryptionMode,@JsonKey(name: 'mls_group_id') String? mlsGroupId, bool isPublic, bool isCommunity,@JsonKey(name: 'is_read_receipts_public') bool isReadReceiptsPublic, SnCloudFileReference? picture, SnCloudFileReference? background, String? realmId, String? accountId, SnRealm? realm, DateTime createdAt, DateTime updatedAt, DateTime? deletedAt, List<SnChatMember>? members, bool isPinned
});
...
/// Create a copy of SnChatRoom
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? description = freezed,Object? slug = freezed,Object? type = null,Object? encryptionMode = null,Object? mlsGroupId = freezed,Object? isPublic = null,Object? isCommunity = null,Object? isReadReceiptsPublic = null,Object? picture = freezed,Object? background = freezed,Object? realmId = freezed,Object? accountId = freezed,Object? realm = freezed,Object? createdAt = null,Object? updatedAt = null,Object? deletedAt = freezed,Object? members = freezed,Object? isPinned = null,}) {
...
as bool,isReadReceiptsPublic: null == isReadReceiptsPublic ? _self.isReadReceiptsPublic : isReadReceiptsPublic // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? name,  String? description,  String? slug,  int type, @JsonKey(name: 'encryption_mode')  int encryptionMode, @JsonKey(name: 'mls_group_id')  String? mlsGroupId,  bool isPublic,  bool isCommunity, @JsonKey(name: 'is_read_receipts_public')  bool isReadReceiptsPublic,  SnCloudFileReference? picture,  SnCloudFileReference? background,  String? realmId,  String? accountId,  SnRealm? realm,  DateTime createdAt,  DateTime updatedAt,  DateTime? deletedAt,  List<SnChatMember>? members,  bool isPinned)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SnChatRoom() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.slug,_that.type,_that.encryptionMode,_that.mlsGroupId,_that.isPublic,_that.isCommunity,_that.isReadReceiptsPublic,_that.picture,_that.background,_that.realmId,_that.accountId,_that.realm,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.members,_that.isPinned);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? name,  String? description,  String? slug,  int type, @JsonKey(name: 'encryption_mode')  int encryptionMode, @JsonKey(name: 'mls_group_id')  String? mlsGroupId,  bool isPublic,  bool isCommunity, @JsonKey(name: 'is_read_receipts_public')  bool isReadReceiptsPublic,  SnCloudFileReference? picture,  SnCloudFileReference? background,  String? realmId,  String? accountId,  SnRealm? realm,  DateTime createdAt,  DateTime updatedAt,  DateTime? deletedAt,  List<SnChatMember>? members,  bool isPinned)  $default,) {final _that = this;
switch (_that) {
case _SnChatRoom():
return $default(_that.id,_that.name,_that.description,_that.slug,_that.type,_that.encryptionMode,_that.mlsGroupId,_that.isPublic,_that.isCommunity,_that.isReadReceiptsPublic,_that.picture,_that.background,_that.realmId,_that.accountId,_that.realm,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.members,_that.isPinned);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? name,  String? description,  String? slug,  int type, @JsonKey(name: 'encryption_mode')  int encryptionMode, @JsonKey(name: 'mls_group_id')  String? mlsGroupId,  bool isPublic,  bool isCommunity, @JsonKey(name: 'is_read_receipts_public')  bool isReadReceiptsPublic,  SnCloudFileReference? picture,  SnCloudFileReference? background,  String? realmId,  String? accountId,  SnRealm? realm,  DateTime createdAt,  DateTime updatedAt,  DateTime? deletedAt,  List<SnChatMember>? members,  bool isPinned)?  $default,) {final _that = this;
switch (_that) {
case _SnChatRoom() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.slug,_that.type,_that.encryptionMode,_that.mlsGroupId,_that.isPublic,_that.isCommunity,_that.isReadReceiptsPublic,_that.picture,_that.background,_that.realmId,_that.accountId,_that.realm,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.members,_that.isPinned);case _:
  return null;
...
class _SnChatRoom implements SnChatRoom {
  const _SnChatRoom({required this.id, required this.name, required this.description, this.slug, required this.type, @JsonKey(name: 'encryption_mode') this.encryptionMode = 0, @JsonKey(name: 'mls_group_id') this.mlsGroupId, this.isPublic = false, this.isCommunity = false, @JsonKey(name: 'is_read_receipts_public') this.isReadReceiptsPublic = true, required this.picture, required this.background, required this.realmId, required this.accountId, required this.realm, required this.createdAt, required this.updatedAt, required this.deletedAt, required  List<SnChatMember>? members, this.isPinned = false}): _members = members;
...
@override@JsonKey(name: 'is_read_receipts_public') final  bool isReadReceiptsPublic;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,slug,type,encryptionMode,mlsGroupId,isPublic,isCommunity,isReadReceiptsPublic,picture,background,realmId,accountId,realm,createdAt,updatedAt,deletedAt,const DeepCollectionEquality().hash(_members),isPinned]);
...
/// @nodoc
mixin _$SnChatEncryptionMeta {

 String get ciphertext; String? get header; String? get signature; String get scheme; int? get epoch;
/// Create a copy of SnChatEncryptionMeta
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SnChatEncryptionMetaCopyWith<SnChatEncryptionMeta> get copyWith => _$SnChatEncryptionMetaCopyWithImpl<SnChatEncryptionMeta>(this as SnChatEncryptionMeta, _$identity);

  /// Serializes this SnChatEncryptionMeta to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SnChatEncryptionMeta&&(identical(other.ciphertext, ciphertext) || other.ciphertext == ciphertext)&&(identical(other.header, header) || other.header == header)&&(identical(other.signature, signature) || other.signature == signature)&&(identical(other.scheme, scheme) || other.scheme == scheme)&&(identical(other.epoch, epoch) || other.epoch == epoch));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,ciphertext,header,signature,scheme,epoch);

@override
String toString() {
  return 'SnChatEncryptionMeta(ciphertext: $ciphertext, header: $header, signature: $signature, scheme: $scheme, epoch: $epoch)';
}
...
/// @nodoc
abstract mixin class $SnChatEncryptionMetaCopyWith<$Res>  {
  factory $SnChatEncryptionMetaCopyWith(SnChatEncryptionMeta value, $Res Function(SnChatEncryptionMeta) _then) = _$SnChatEncryptionMetaCopyWithImpl;
@useResult
$Res call({
 String ciphertext, String? header, String? signature, String scheme, int? epoch
});
...
/// @nodoc
class _$SnChatEncryptionMetaCopyWithImpl<$Res>
    implements $SnChatEncryptionMetaCopyWith<$Res> {
  _$SnChatEncryptionMetaCopyWithImpl(this._self, this._then);

  final SnChatEncryptionMeta _self;
  final $Res Function(SnChatEncryptionMeta) _then;

/// Create a copy of SnChatEncryptionMeta
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? ciphertext = null,Object? header = freezed,Object? signature = freezed,Object? scheme = null,Object? epoch = freezed,}) {
  return _then(SnChatEncryptionMeta(
...
as String,epoch: freezed == epoch ? _self.epoch : epoch // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
/// Adds pattern-matching-related methods to [SnChatEncryptionMeta].
extension SnChatEncryptionMetaPatterns on SnChatEncryptionMeta {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SnChatEncryptionMeta value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SnChatEncryptionMeta() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SnChatEncryptionMeta value)  $default,){
final _that = this;
switch (_that) {
case _SnChatEncryptionMeta():
return $default(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SnChatEncryptionMeta value)?  $default,){
final _that = this;
switch (_that) {
case _SnChatEncryptionMeta() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ciphertext,  String? header,  String? signature,  String scheme,  int? epoch)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SnChatEncryptionMeta() when $default != null:
return $default(_that.ciphertext,_that.header,_that.signature,_that.scheme,_that.epoch);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ciphertext,  String? header,  String? signature,  String scheme,  int? epoch)  $default,) {final _that = this;
switch (_that) {
case _SnChatEncryptionMeta():
return $default(_that.ciphertext,_that.header,_that.signature,_that.scheme,_that.epoch);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ciphertext,  String? header,  String? signature,  String scheme,  int? epoch)?  $default,) {final _that = this;
switch (_that) {
case _SnChatEncryptionMeta() when $default != null:
return $default(_that.ciphertext,_that.header,_that.signature,_that.scheme,_that.epoch);case _:
  return null;
...
class _SnChatEncryptionMeta implements SnChatEncryptionMeta {
  const _SnChatEncryptionMeta({required this.ciphertext, this.header, this.signature, required this.scheme, this.epoch});
  factory _SnChatEncryptionMeta.fromJson(Map<String, dynamic> json) => _$SnChatEncryptionMetaFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$SnChatEncryptionMetaCopyWith<_SnChatEncryptionMeta> get copyWith => __$SnChatEncryptionMetaCopyWithImpl<_SnChatEncryptionMeta>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SnChatEncryptionMetaToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SnChatEncryptionMeta&&(identical(other.ciphertext, ciphertext) || other.ciphertext == ciphertext)&&(identical(other.header, header) || other.header == header)&&(identical(other.signature, signature) || other.signature == signature)&&(identical(other.scheme, scheme) || other.scheme == scheme)&&(identical(other.epoch, epoch) || other.epoch == epoch));
}
...
/// @nodoc
abstract mixin class _$SnChatEncryptionMetaCopyWith<$Res> implements $SnChatEncryptionMetaCopyWith<$Res> {
  factory _$SnChatEncryptionMetaCopyWith(_SnChatEncryptionMeta value, $Res Function(_SnChatEncryptionMeta) _then) = __$SnChatEncryptionMetaCopyWithImpl;
@override @useResult
$Res call({
 String ciphertext, String? header, String? signature, String scheme, int? epoch
});
...
/// @nodoc
class __$SnChatEncryptionMetaCopyWithImpl<$Res>
    implements _$SnChatEncryptionMetaCopyWith<$Res> {
  __$SnChatEncryptionMetaCopyWithImpl(this._self, this._then);

  final _SnChatEncryptionMeta _self;
  final $Res Function(_SnChatEncryptionMeta) _then;

/// Create a copy of SnChatEncryptionMeta
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? ciphertext = null,Object? header = freezed,Object? signature = freezed,Object? scheme = null,Object? epoch = freezed,}) {
  return _then(_SnChatEncryptionMeta(
ciphertext: null == ciphertext ? _self.ciphertext : ciphertext // ignore: cast_nullable_to_non_nullable
as String,header: freezed == header ? _self.header : header // ignore: cast_nullable_to_non_nullable
as String?,signature: freezed == signature ? _self.signature : signature // ignore: cast_nullable_to_non_nullable
as String?,scheme: null == scheme ? _self.scheme : scheme // ignore: cast_nullable_to_non_nullable
...
mixin _$SnChatMessage {
 ...
 DateTime get createdAt; DateTime get updatedAt; DateTime? get deletedAt; String get id; String get type; String? get content;@JsonKey(name: 'client_message_id') String? get clientMessageId; String? get nonce;@JsonKey(name: 'encryption_meta') SnChatEncryptionMeta? get encryptionMeta; Map<String, dynamic> get meta; List<String> get membersMentioned; DateTime? get editedAt; List<SnCloudFileReference> get attachments; List<SnChatReaction> get reactions;@JsonKey(name: 'reactions_count') Map<String, int> get reactionsCount;@JsonKey(name: 'reactions_made') Map<String, bool> get reactionsMade;@JsonKey(name: 'is_thread_root') bool get isThreadRoot;@JsonKey(name: 'thread_replies_count') int get threadRepliesCount;@JsonKey(name: 'thread_replies') List<ThreadReplyNode> get threadReplies; String? get repliedMessageId;/// Id of the thread root this message belongs to. Null for top-level
/// messages and regular (direct) replies; set for replies created via
/// "reply in thread".
@JsonKey(name: 'thread_id') String? get threadId; String? get forwardedMessageId; String get senderId; SnChatMember get sender; String get chatRoomId;
...
as String?,encryptionMeta: freezed == encryptionMeta ? _self.encryptionMeta : encryptionMeta // ignore: cast_nullable_to_non_nullable
as SnChatEncryptionMeta?,meta: null == meta ? _self.meta : meta // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$SnChatEncryptionMetaCopyWith<$Res>? get encryptionMeta {
    if (_self.encryptionMeta == null) {
    return null;
  }

  return $SnChatEncryptionMetaCopyWith<$Res>(_self.encryptionMeta!, (value) {
    return _then(_self.copyWith(encryptionMeta: value));
  });
}/// Create a copy of SnChatMessage
/// with the given fields replaced by the non-null parameter values.
@override
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime createdAt,  DateTime updatedAt,  DateTime? deletedAt,  String id,  String type,  String? content, @JsonKey(name: 'client_message_id')  String? clientMessageId,  String? nonce, @JsonKey(name: 'encryption_meta')  SnChatEncryptionMeta? encryptionMeta,  Map<String, dynamic> meta,  List<String> membersMentioned,  DateTime? editedAt,  List<SnCloudFileReference> attachments,  List<SnChatReaction> reactions, @JsonKey(name: 'reactions_count')  Map<String, int> reactionsCount, @JsonKey(name: 'reactions_made')  Map<String, bool> reactionsMade, @JsonKey(name: 'is_thread_root')  bool isThreadRoot, @JsonKey(name: 'thread_replies_count')  int threadRepliesCount, @JsonKey(name: 'thread_replies')  List<ThreadReplyNode> threadReplies,  String? repliedMessageId, @JsonKey(name: 'thread_id')  String? threadId,  String? forwardedMessageId,  String senderId,  SnChatMember sender,  String chatRoomId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SnChatMessage() when $default != null:
return $default(_that.createdAt,_that.updatedAt,_that.deletedAt,_that.id,_that.type,_that.content,_that.clientMessageId,_that.nonce,_that.encryptionMeta,_that.meta,_that.membersMentioned,_that.editedAt,_that.attachments,_that.reactions,_that.reactionsCount,_that.reactionsMade,_that.isThreadRoot,_that.threadRepliesCount,_that.threadReplies,_that.repliedMessageId,_that.threadId,_that.forwardedMessageId,_that.senderId,_that.sender,_that.chatRoomId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime createdAt,  DateTime updatedAt,  DateTime? deletedAt,  String id,  String type,  String? content, @JsonKey(name: 'client_message_id')  String? clientMessageId,  String? nonce, @JsonKey(name: 'encryption_meta')  SnChatEncryptionMeta? encryptionMeta,  Map<String, dynamic> meta,  List<String> membersMentioned,  DateTime? editedAt,  List<SnCloudFileReference> attachments,  List<SnChatReaction> reactions, @JsonKey(name: 'reactions_count')  Map<String, int> reactionsCount, @JsonKey(name: 'reactions_made')  Map<String, bool> reactionsMade, @JsonKey(name: 'is_thread_root')  bool isThreadRoot, @JsonKey(name: 'thread_replies_count')  int threadRepliesCount, @JsonKey(name: 'thread_replies')  List<ThreadReplyNode> threadReplies,  String? repliedMessageId, @JsonKey(name: 'thread_id')  String? threadId,  String? forwardedMessageId,  String senderId,  SnChatMember sender,  String chatRoomId)  $default,) {final _that = this;
switch (_that) {
case _SnChatMessage():
...
@override@JsonKey(name: 'encryption_meta') final  SnChatEncryptionMeta? encryptionMeta;
...
@override $SnChatEncryptionMetaCopyWith<$Res>? get encryptionMeta;@override $SnChatMemberCopyWith<$Res> get sender;
...
as String?,nonce: freezed == nonce ? _self.nonce : nonce // ignore: cast_nullable_to_non_nullable
as String?,encryptionMeta: freezed == encryptionMeta ? _self.encryptionMeta : encryptionMeta // ignore: cast_nullable_to_non_nullable
as SnChatEncryptionMeta?,meta: null == meta ? _self._meta : meta // ignore: cast_nullable_to_non_nullable
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,createdAt,updatedAt,deletedAt,id,chatRoomId,chatRoom,accountId,account,nick,notify,joinedAt,leaveAt,confirmedAt,breakUntil,timeoutUntil,chatGroupId,chatGroup,lastReadAt,status,realmNick,realmBio,realmExperience,realmLevel,realmLevelingProgress,realmLabel,lastTyped]);

@override
String toString() {
  return 'SnChatMember(createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, id: $id, chatRoomId: $chatRoomId, chatRoom: $chatRoom, accountId: $accountId, account: $account, nick: $nick, notify: $notify, joinedAt: $joinedAt, leaveAt: $leaveAt, confirmedAt: $confirmedAt, breakUntil: $breakUntil, timeoutUntil: $timeoutUntil, chatGroupId: $chatGroupId, chatGroup: $chatGroup, lastReadAt: $lastReadAt, status: $status, realmNick: $realmNick, realmBio: $realmBio, realmExperience: $realmExperience, realmLevel: $realmLevel, realmLevelingProgress: $realmLevelingProgress, realmLabel: $realmLabel, lastTyped: $lastTyped)';
}
...
as DateTime?,leaveAt: freezed == leaveAt ? _self.leaveAt : leaveAt // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _SnChatMember() when $default != null:
return $default(_that.createdAt,_that.updatedAt,_that.deletedAt,_that.id,_that.chatRoomId,_that.chatRoom,_that.accountId,_that.account,_that.nick,_that.notify,_that.joinedAt,_that.leaveAt,_that.confirmedAt,_that.breakUntil,_that.timeoutUntil,_that.chatGroupId,_that.chatGroup,_that.lastReadAt,_that.status,_that.realmNick,_that.realmBio,_that.realmExperience,_that.realmLevel,_that.realmLevelingProgress,_that.realmLabel,_that.lastTyped);case _:
  return orElse();
...
@override@JsonKey(name: 'leave_at') final  DateTime? leaveAt;
