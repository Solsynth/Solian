...
mixin _$SnScanResult {
 ...
 String get id; SnAccount? get account; bool get isFriend; bool get isClaimed; List<String> get actions;
...
@useResult
$Res call({
 String id, SnAccount? account, bool isFriend, bool isClaimed, List<String> actions
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  SnAccount? account,  bool isFriend,  bool isClaimed,  List<String> actions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SnScanResult() when $default != null:
return $default(_that.id,_that.account,_that.isFriend,_that.isClaimed,_that.actions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  SnAccount? account,  bool isFriend,  bool isClaimed,  List<String> actions)  $default,) {final _that = this;
switch (_that) {
case _SnScanResult():
return $default(_that.id,_that.account,_that.isFriend,_that.isClaimed,_that.actions);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  SnAccount? account,  bool isFriend,  bool isClaimed,  List<String> actions)?  $default,) {final _that = this;
switch (_that) {
case _SnScanResult() when $default != null:
return $default(_that.id,_that.account,_that.isFriend,_that.isClaimed,_that.actions);case _:
  return null;
...
/// Create a copy of SnScanResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? account = freezed,Object? isFriend = null,Object? isClaimed = null,Object? actions = null,}) {
